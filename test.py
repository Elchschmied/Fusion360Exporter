...
class TotalExport(object):
    ...
    def run(self, context):
        ...
        # Wiederholen bei Verbindungsfehlern auf oberster Ebene
        while True:
            try:
    ...
    def _write_data_file(self, root_folder, file):
        ...
        Bei Verbindungsproblemen kann der Benutzer den Schritt wiederholen.
        """
        ...
        document = None
        # Versuch, das Dokument zu öffnen, mit Wiederholungsoption bei Fehlern
        while True:
            try:
                ...
                if result == adsk.core.DialogResults.DialogYes:
                    ...
                    # Benutzer möchte nicht wiederholen -> Datei überspringen
                    self.num_issues += 1
                    self.log.info(
        ...
        try:
            ...
            # Fusion-Archiv (.f3d/.f3z) exportieren, mit Wiederholungsoption.
